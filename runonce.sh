...
#sup kapps_config set_json crossbar autoload_modules '["cb_about","cb_accounts","cb_alerts","cb_api_auth","cb_apps_store","cb_auth","cb_basic_auth","cb_blacklists","cb_callflows","cb_cdrs","cb_channels","cb_clicktocall","cb_comments","cb_conferences","cb_configs","cb_connectivity","cb_contact_list","cb_devices","cb_directories","cb_faxboxes","cb_faxes","cb_groups","cb_hotdesks","cb_ips","cb_ledgers","cb_limits","cb_media","cb_menus","cb_metaflows","cb_multi_factor","cb_notifications","cb_parked_calls","cb_phone_numbers","cb_pivot","cb_presence","cb_quickcall","cb_rates","cb_registrations","cb_resource_templates","cb_resources","cb_schemas","cb_search","cb_security","cb_services","cb_simple_authz","cb_sms","cb_system_configs","cb_tasks","cb_templates","cb_temporal_rules","cb_temporal_rules_sets","cb_token_auth","cb_token_restrictions","cb_transactions","cb_user_auth","cb_users","cb_vmboxes","cb_webhooks","cb_websockets","cb_whitelabel"]'
